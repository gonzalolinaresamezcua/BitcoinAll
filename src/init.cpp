...
#endif
    argsman.AddArg("-btcaallowgenerate", "BTCA: allow local block generation helpers (generatetoaddress) on live/main for bootstrap demos (default: 0). Production validation-only nodes should leave this disabled.", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::DEBUG_TEST);
