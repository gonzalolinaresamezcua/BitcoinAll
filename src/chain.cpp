...
{
    // PoW no se usa. Cada bloque contribuye con "1" al chainwork.
    // El parámetro block ya no se usa directamente aquí, pero se mantiene por compatibilidad de firma.
    // nBits ya no se usa para calcular el trabajo.
